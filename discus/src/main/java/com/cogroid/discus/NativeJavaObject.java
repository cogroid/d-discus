 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/NativeJavaObject.java
 *
 * CD
 */
...
*/
     ...
     * @see com.cogroid.discus.Context#jsToJava(Object, Class)
     */
    ...
    static {
        ...
        Class<?> cl = Kit.classOrNull("com.cogroid.discus.JavaAdapter");
        if (cl != null) {
            try {
