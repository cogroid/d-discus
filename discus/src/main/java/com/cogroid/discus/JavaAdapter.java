 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/com/starohub/discus/JavaAdapter.java
 *
 * CD
 */
...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lcom/starohub/discus/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lcom/starohub/discus/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lcom/starohub/discus/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName)
    {
        cfw.startMethod("<init>",
                        "(Lcom/starohub/discus/ContextFactory;"
                        +"Lcom/starohub/discus/Scriptable;)V",
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com/starohub/discus/JavaAdapter",
