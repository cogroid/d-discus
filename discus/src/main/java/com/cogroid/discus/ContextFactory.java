 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/ContextFactory.java
 *
 * CD
 */
...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link com.cogroid.discus.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected com.cogroid.discus.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return com.cogroid.discus.xml.XMLLib.Factory.create(
                "com.cogroid.discus.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return com.cogroid.discus.xml.XMLLib.Factory.create(
                "com.cogroid.discus.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
