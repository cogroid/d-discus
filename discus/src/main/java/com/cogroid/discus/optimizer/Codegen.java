 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/com/starohub/discus/optimizer/Codegen.java
 *
 * CD
 */
...
package com.cogroid.discus.optimizer;

import com.cogroid.discus.*;
import com.cogroid.discus.ast.FunctionNode;
import com.cogroid.discus.ast.Jump;
import com.cogroid.discus.ast.Name;
import com.cogroid.discus.ast.ScriptNode;
import com.cogroid.discus.classfile.*;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "com.cogroid.discus.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("com/starohub/discus/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "com/starohub/discus/BaseFunction",
                      "createObject",
                      "(Lcom/starohub/discus/Context;"
                      +"Lcom/starohub/discus/Scriptable;"
                      +")Lcom/starohub/discus/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "com/starohub/discus/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "com/starohub/discus/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com/starohub/discus/ScriptRuntime",
                      "hasTopCall",
                      "(Lcom/starohub/discus/Context;"
                      +")Z");
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lcom/starohub/discus/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "com/starohub/discus/NativeFunction",
                      "initScriptFunction",
                      "(Lcom/starohub/discus/Context;"
                      +"Lcom/starohub/discus/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "com/starohub/discus/RegExpProxy",
                              "compileRegExp",
                              "(Lcom/starohub/discus/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lcom/starohub/discus/Context;"
                      +")Lcom/starohub/discus/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "com/starohub/discus/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "com/starohub/discus/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Lcom/starohub/discus/Context;"
                  +"Lcom/starohub/discus/Scriptable;"
                  +"Lcom/starohub/discus/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
    ...
    static RuntimeException badTree()
    {
     ...
     static final String DEFAULT_MAIN_METHOD_CLASS
        = "com.cogroid.discus.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME
        = "com.cogroid.discus.NativeFunction";
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lcom/starohub/discus/Scriptable;"
          +"Lcom/starohub/discus/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "com/starohub/discus/Scriptable",
                          "getParentScope",
                          "()Lcom/starohub/discus/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lcom/starohub/discus/NativeFunction;"
                               +"Lcom/starohub/discus/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lcom/starohub/discus/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lcom/starohub/discus/NativeFunction;"
                               +"Lcom/starohub/discus/Scriptable;"
                               +"Lcom/starohub/discus/Scriptable;II"
                               +")Lcom/starohub/discus/Scriptable;");
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lcom/starohub/discus/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "com/starohub/discus/JavaScriptException");
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lcom/starohub/discus/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lcom/starohub/discus/Scriptable;"
                            +"Lcom/starohub/discus/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lcom/starohub/discus/Callable;"
                            +"Lcom/starohub/discus/Scriptable;"
                            +"Lcom/starohub/discus/Context;"
                            +"Lcom/starohub/discus/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "com/starohub/discus/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "com/starohub/discus/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "com/starohub/discus/EcmaError";
    ...
    {
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com.cogroid.discus.ScriptRuntime",
                      methodName,
                      methodSignature);
    }
