 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/Context.java
 *
 * CD
 */
...
import com.cogroid.discus.ast.AstRoot;
import com.cogroid.discus.ast.ScriptNode;
import com.cogroid.discus.debug.DebuggableScript;
import com.cogroid.discus.debug.Debugger;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(com.cogroid.discus.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "com.cogroid.discus.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "com.cogroid.discus.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(com.cogroid.discus.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see com.cogroid.discus.ErrorReporter
     */
     ...
     * @see com.cogroid.discus.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (com.cogroid.discus.NativeContinuation) continuation,
                this, scope, args);
    }
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "com.cogroid.discus.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "com.cogroid.discus.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "com.cogroid.discus.regexp.RegExpImpl");
            if (cl != null) {
