 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/toolsrc/org/mozilla/javascript/tools/debugger/Main.java
 *
 * CD
 */
...
import com.cogroid.discus.tools.shell.Global;
...
public class Main {
     ...
     * {@link com.cogroid.discus.tools.shell.Main} shell session.
     */
    public static void main(String[] args) {
        ...
        Global global = com.cogroid.discus.tools.shell.Main.getGlobal();
        global.setIn(main.getIn());
        global.setOut(main.getOut());
        global.setErr(main.getErr());

        main.attachTo(
                com.cogroid.discus.tools.shell.Main.shellContextFactory);
        ...
        com.cogroid.discus.tools.shell.Main.exec(args);
    }
