 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/toolsrc/org/mozilla/javascript/tools/jsc/Main.java
 *
 * CD
 */
...
package com.cogroid.discus.tools.jsc;

import java.io.*;
import java.util.*;
import com.cogroid.discus.*;
import com.cogroid.discus.optimizer.ClassCompiler;
