 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/Scriptable.java
 *
 * CD
 */
...
public interface Scriptable {
     ...
     * <LI>com.cogroid.discus.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see com.cogroid.discus.Context#getUndefinedValue
     */
     ...
     * @see com.cogroid.discus.Scriptable#get(String, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see com.cogroid.discus.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see com.cogroid.discus.Scriptable#get(String, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see com.cogroid.discus.Context#toObject(Object, Scriptable)
     */
     ...
     * @see com.cogroid.discus.Scriptable#get(int, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see com.cogroid.discus.Context#toObject(Object, Scriptable)
     */
     ...
     * @see com.cogroid.discus.Scriptable#get(String, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see com.cogroid.discus.Scriptable#get(int, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#deleteProperty(Scriptable, int)
     */
