 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/ContinuationPending.java
 *
 * CD
 */
...
/**
 * Exception thrown by 
 * {@link com.cogroid.discus.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link com.cogroid.discus.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link com.cogroid.discus.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link com.cogroid.discus.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link com.cogroid.discus.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link com.cogroid.discus.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link com.cogroid.discus.Context#resumeContinuation(Object, Scriptable, Object)}.
