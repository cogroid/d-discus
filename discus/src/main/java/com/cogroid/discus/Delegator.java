 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/Delegator.java
 *
 * CD
 */
...
public class Delegator implements Function {
     ...
     *
     * @see com.cogroid.discus.Delegator#construct
     */
    public Delegator() {
    }
    ...
    /**
     * @see com.cogroid.discus.Scriptable#getClassName
     */
    public String getClassName() {
        return obj.getClassName();
    }
    /**
     * @see com.cogroid.discus.Scriptable#get(String, Scriptable)
     */
    public Object get(String name, Scriptable start) {
        return obj.get(name,start);
    }
    /**
     * @see com.cogroid.discus.Scriptable#get(int, Scriptable)
     */
    ...
    /**
     * @see com.cogroid.discus.Scriptable#has(int, Scriptable)
     */
    ...
    /**
     * @see com.cogroid.discus.Scriptable#put(int, Scriptable, Object)
     */
    public void put(int index, Scriptable start, Object value) {
        obj.put(index,start,value);
    }
    /**
     * @see com.cogroid.discus.Scriptable#delete(String)
     */
    public void delete(String name) {
        obj.delete(name);
    }
    /**
     * @see com.cogroid.discus.Scriptable#delete(int)
     */
    public void delete(int index) {
        obj.delete(index);
    }
    /**
     * @see com.cogroid.discus.Scriptable#getPrototype
     */
    public Scriptable getPrototype() {
        return obj.getPrototype();
    }
    /**
     * @see com.cogroid.discus.Scriptable#setPrototype
     */
    public void setPrototype(Scriptable prototype) {
        obj.setPrototype(prototype);
    }
    /**
     * @see com.cogroid.discus.Scriptable#getParentScope
     */
    public Scriptable getParentScope() {
        return obj.getParentScope();
    }
    /**
     * @see com.cogroid.discus.Scriptable#setParentScope
     */
    public void setParentScope(Scriptable parent) {
        obj.setParentScope(parent);
    }
    /**
     * @see com.cogroid.discus.Scriptable#getIds
     */
     ...
     *
     * @see com.cogroid.discus.Scriptable#getDefaultValue
     */
    ...
    /**
     * @see com.cogroid.discus.Scriptable#hasInstance
     */
    public boolean hasInstance(Scriptable instance) {
        return obj.hasInstance(instance);
    }
    /**
     * @see com.cogroid.discus.Function#call
     */
