 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/ast/VariableDeclaration.java
 *
 * CD
 */
...
public class VariableDeclaration extends AstNode {
     ...
     */
    @Override
    public com.cogroid.discus.Node setType(int type) {
        if (type != Token.VAR
            && type != Token.CONST
            && type != Token.LET)
