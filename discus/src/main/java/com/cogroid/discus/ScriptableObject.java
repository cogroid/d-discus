 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/ScriptableObject.java
 *
 * CD
 */
...
import com.cogroid.discus.debug.DebuggableObject;
import com.cogroid.discus.annotations.JSConstructor;
import com.cogroid.discus.annotations.JSFunction;
import com.cogroid.discus.annotations.JSGetter;
import com.cogroid.discus.annotations.JSSetter;
import com.cogroid.discus.annotations.JSStaticFunction;
 ...
 *
 * @see com.cogroid.discus.Scriptable
 * @author Norris Boyd
 */
                                                  ...
                                                  ConstProperties
{
     ...
     *
     * @see com.cogroid.discus.ScriptableObject#getAttributes(String)
     * @see com.cogroid.discus.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see com.cogroid.discus.ScriptableObject
     ...
     *
     * @see com.cogroid.discus.ScriptableObject#getIds()
     * @see com.cogroid.discus.ScriptableObject#getAttributes(String)
     * @see com.cogroid.discus.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see com.cogroid.discus.ScriptableObject#delete(String)
     * @see com.cogroid.discus.ScriptableObject#getAttributes(String)
     * @see com.cogroid.discus.ScriptableObject#setAttributes(String, int)
     */
     ...
     * @see com.cogroid.discus.ScriptableObject#has(String, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#READONLY
     * @see com.cogroid.discus.ScriptableObject#DONTENUM
     * @see com.cogroid.discus.ScriptableObject#PERMANENT
     * @see com.cogroid.discus.ScriptableObject#EMPTY
     */
     ...
     * @exception EvaluatorException if the named property is not found
     * @see com.cogroid.discus.Scriptable#has(String, Scriptable)
     * @see com.cogroid.discus.ScriptableObject#READONLY
     * @see com.cogroid.discus.ScriptableObject#DONTENUM
     * @see com.cogroid.discus.ScriptableObject#PERMANENT
     * @see com.cogroid.discus.ScriptableObject#EMPTY
     ...
     * @see com.cogroid.discus.Function
     * @see com.cogroid.discus.FunctionObject
     * @see com.cogroid.discus.ScriptableObject#READONLY
     * @see com.cogroid.discus.ScriptableObject
     ...
     * @see com.cogroid.discus.Scriptable#put(String, Scriptable, Object)
     */
