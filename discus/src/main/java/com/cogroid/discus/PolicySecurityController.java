 ...
 *
 * Ref: https://github.com/mozilla/rhino/blob/Rhino1_7R3_RELEASE/src/org/mozilla/javascript/PolicySecurityController.java
 *
 * CD
 */
...
import com.cogroid.discus.classfile.ByteCode;
import com.cogroid.discus.classfile.ClassFileWriter;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Lcom/starohub/discus/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE, 
                "com/starohub/discus/Callable", "call",
                "(" + callableCallSig);
